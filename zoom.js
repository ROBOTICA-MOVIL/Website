...
//ESTE ES UN ESTADO EN EL QUE LA IMAGEN DE FONDO ES MAS GRANDE, CREANDO UN EFECTO DE ZOOM.
var Zoom = {
    ...
    preload: function () {
        ...
        juego.load.image("botonL", "img/91.png");  //AL IGUAL QUE EL FONDO TAMBIÉN ES NECESARIO CAMBIAR LOS BOTONES DE BITMAPS.
    },
    
    create: function () {
        fondojuego = juego.add.sprite(720, 480, "fondo");
        fondojuego.position.x = -240;
        fondojuego.position.y = -246;
        //juego.physics.startSystem(Phaser.Physics.ARCADE);
        
        //EN ESTE ESTADO TODOS LOS BOTONES TIENE COORDENADS DISTINTAS A LAS DEL ESTADO PRINCIPAL.
        ...
        botonLE9 = juego.add.button(80, 402, "botonL", this.nine, this);
        botonLE9.anchor.setTo(0.5);
        botonLE9.alpha = 0.4;
        
        botonLE8 = juego.add.button(333, 249, "botonL", this.eight, this);
        botonLE8.anchor.setTo(0.5);
        botonLE8.alpha = 0.4;

        botonLE7 = juego.add.button(488, 1, "botonL", this.seven, this);
		botonLE7.anchor.setTo(0.5);
        botonLE7.alpha = 0.4;
        
        botonLE6 = juego.add.button(564, 181, "botonL", this.six, this);
		botonLE6.anchor.setTo(0.5);
        botonLE6.alpha = 0.4;
        
        botonLE5 = juego.add.button(445, 1, "botonL", this.five, this);
		botonLE5.anchor.setTo(0.5);
        botonLE5.alpha = 0.4;
        
        botonLE4 = juego.add.button(533, 129, "botonL", this.four, this);
		botonLE4.anchor.setTo(0.5);
        botonLE4.alpha = 0.4;
        
        botonLE3 = juego.add.button(540, -2, "botonL", this.three, this);
		botonLE3.anchor.setTo(0.5);
        botonLE3.alpha = 0.4;
        
        botonLE2 = juego.add.button(628, 65, "botonL", this.two, this);
		botonLE2.anchor.setTo(0.5);
        botonLE2.alpha = 0.4;
        
        botonLE1 = juego.add.button(481, 177, "botonL", this.one, this);
		botonLE1.anchor.setTo(0.5);
        botonLE1.alpha = 0.4;
        
        botonLE10 = juego.add.button(719, 549, "botonL", this.ten, this);
    ...
    izquierda: function () {
        if (fondojuego.position.x < 0) {//AL CAMBIAR EL TAMAÑO DEL FONDO, LOGICAMENTE DEBEN CAMBIAR TAMBIÉN SUS RESTRICCIONES DE MOVIMIENTO.
    ...
    //FUNCIONES DE CREACIÓN DE BITMAPS.
...
juego.state.add("Zoom", Zoom);      //SE AÑADE EL ESTADO DEL JUEGO.